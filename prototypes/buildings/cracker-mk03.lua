...
ENTITY {
    ...
    minable = {mining_time = 1, result = "cracker-mk03"},
    ...
    animation = {
        layers = {
            {
                filename = "__pypetroleumhandling__/graphics/entity/cracker-mk03/left-mk03.png",
                width = 128,
                height = 234,
                line_length = 16,
                frame_count = 100,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/cracker-mk03/right-mk03.png",
                width = 128,
                height = 234,
                line_length = 16,
                frame_count = 100,
