...
ENTITY {
    ...
    minable = {mining_time = 1, result = "gas-refinery-mk01"},
    ...
    working_sound = {
        sound = {filename = "__pypetroleumhandling__/sounds/reformer.ogg", volume = 1.5},
        idle_sound = {filename = "__pypetroleumhandling__/sounds/reformer.ogg", volume = 1.0},
        apparent_volume = 2.5
    }
}
