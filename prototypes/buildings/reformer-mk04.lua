...
ENTITY {
    ...
    animation = {
        layers = {
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i1.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i2.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i3.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i4.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i5.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i6.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/reformer-mk04/i7.png",
                width = 64,
                height = 769,
                frame_count = 50,
                line_length = 25,
