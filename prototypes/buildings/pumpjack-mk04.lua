...
ENTITY {
    ...
    fluid_boxes = {
        --1
        {
            ...
            volume = 100,
            pipe_connections = {{flow_direction = "output", position = {-3.0, 5.4}, direction = defines.direction.south}}
        },
        {
            ...
            volume = 1000,
            base_level = -1,
            pipe_connections = {{flow_direction = "input", position = {3.0, -5.4}, direction = defines.direction.north}}
        },
