...
ENTITY {
    ...
    fluid_boxes = {
        --1
        {
            ...
            volume = 1000,
            pipe_connections = {{flow_direction = "input", position = {-1.0, -7.0}, direction = defines.direction.north}}
        },
        {
            production_type = "input",
            pipe_picture = py.pipe_pictures("assembling-machine-2", nil, {0.0, -0.96}, nil, nil),
            pipe_covers = py.pipe_covers(false, true, true, true),
            volume = 1000,
            pipe_connections = {{flow_direction = "input", position = {-7.0, 1.0}, direction = defines.direction.west}}
        },
        {
