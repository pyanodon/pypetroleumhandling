...
ENTITY {
    ...
    minable = {mining_time = 1, result = "upgrader-mk03"},
    ...
    animation = {
        layers = {
            {
                filename = "__pypetroleumhandling__/graphics/entity/upgrader-mk03/left-mk03.png",
                width = 128,
                height = 352,
                line_length = 16,
                frame_count = 80,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/upgrader-mk03/right-mk03.png",
                width = 128,
                height = 352,
                line_length = 16,
                frame_count = 80,
