...
ENTITY {
    ...
    minable = {mining_time = 1, result = "heavy-oil-refinery-mk03"},
    ...
    animation = {
        layers = {
            {
                filename = "__pypetroleumhandling__/graphics/entity/heavy-oil-refinery-mk03/off-mk03.png",
                width = 448,
                height = 551,
                frame_count = 1,
    ...
    working_visualisations = {
        {
            ...
            animation = {
                filename = "__pypetroleumhandling__/graphics/entity/heavy-oil-refinery-mk03/bot.png",
                --priority = "low",
                frame_count = 50,
                line_length = 8,
                width = 224,
        ...
        },
        {
            ...
            animation = {
                filename = "__pypetroleumhandling__/graphics/entity/heavy-oil-refinery-mk03/top.png",
                --priority = "low",
                frame_count = 50,
                line_length = 8,
                width = 224,
