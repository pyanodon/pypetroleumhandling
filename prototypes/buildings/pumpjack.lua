...
for i = 1, 4 do
    ...
    ENTITY {
        ...
        working_sound = {
            sound = {
                filename = "__pypetroleumhandlinggraphics__/sounds/pumpjack-mk0" .. sound_indexes[i] .. ".ogg", --lazy implementation via indexes, idk how to "if" this parameter properly
                volume = 0.8
            },
            idle_sound = {
                filename = "__pypetroleumhandlinggraphics__/sounds/pumpjack-mk0" .. sound_indexes[i] .. ".ogg",
                volume = 0.3
            }
        }
    }
