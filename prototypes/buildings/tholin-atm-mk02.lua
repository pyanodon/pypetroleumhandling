...
ENTITY {
    ...
    minable = {mining_time = 1, result = "tholin-atm-mk02"},
    ...
    animation = {
        layers = {
            {
                filename = "__pypetroleumhandling__/graphics/entity/tholin-atm-mk02/base-mk02.png",
                width = 300,
                height = 352,
                line_length = 6,
                frame_count = 30,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/tholin-atm-mk02/baloon-mk02.png",
                width = 320,
                height = 384,
                line_length = 6,
                frame_count = 30,
            ...
            {
                filename = "__pypetroleumhandling__/graphics/entity/tholin-atm-mk02/helice-mk02.png",
                width = 96,
                height = 64,
                line_length = 6,
                frame_count = 60,
