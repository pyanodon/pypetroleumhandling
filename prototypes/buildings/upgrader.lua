...
for i = 1, 4 do
    local name = "upgrader-mk0" .. i
    local icon = "__pypetroleumhandlinggraphics__/graphics/icons/upgrader-mk0" .. i .. ".png"
    local icon_size = 64
    ...
    ENTITY {
        ...
        next_upgrade = i ~= 4 and "upgrader-mk0" .. (i + 1) or nil,
        max_health = 100,
