...
for i = 1, 4 do
    local name = "oil-sand-extractor-mk0" .. i
    local icon = "__pypetroleumhandlinggraphics__/graphics/icons/oil-sand-extractor-mk0" .. i .. ".png"
    local icon_size = 64
    ...
    ENTITY {
        ...
        working_sound = {
            sound = {
                filename = "__pypetroleumhandlinggraphics__/sounds/oil-sand-extractor.ogg",
                volume = 1.0
            },
            idle_sound = {
                filename = "__pypetroleumhandlinggraphics__/sounds/oil-sand-extractor.ogg",
