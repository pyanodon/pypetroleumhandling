...
RECIPE("thickener-mk01"):remove_unlock("molybdenum-processing"):add_unlock("vanadium-processing")
...
RECIPE("natural-gas-derrick-mk04"):replace_ingredient("distilator", "distilator-mk04")
...
RECIPE("py-tank-10"):replace_ingredient("iron-plate", "duralumin"):replace_ingredient("steel-plate", "lead-plate")
