...
if mods.pyrawores then engine_unit_2:replace_ingredient("steel-plate", "duralumin") end
...
if mods.pyrawores then long_handed_inserter_2:replace_ingredient("steel-plate", "duralumin") end
