...
ITEM {
    ...
    pictures =
    {
        ...
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p15.png", scale = 0.66},
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p23.png", scale = 0.66},
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p25.png", scale = 0.66},
    },
    flags = {},
    subgroup = "py-petroleum-handling-items",
    order = "a",
...
ITEM {
    ...
    pictures =
    {
        ...
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p16.png", scale = 0.66},
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p18.png", scale = 0.66},
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p28.png", scale = 0.66},
    },
    flags = {},
    subgroup = "py-petroleum-handling-items",
    order = "a",
...
ITEM {
    ...
    pictures =
    {
        ...
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p22.png", scale = 0.66},
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p21.png", scale = 0.66},
        {size = 64, filename = "__pypetroleumhandlinggraphics__/graphics/icons/mip/p26.png", scale = 0.66},
    },
    flags = {},
    subgroup = "py-petroleum-handling-items",
    order = "a",
